document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("add-patient").addEventListener("click", showAddPatientForm);
    ...
    document.getElementById("add-appointment").addEventListener("click", showAddAppointmentForm);
    document.getElementById("add-item").addEventListener("click", showAddInventoryItemForm);
    document.getElementById("inventory-search").addEventListener("input", searchInventory);
    document.getElementById("generate-financial-report").addEventListener("click", generateFinancialReport);
    ...
    document.querySelector('a[href="#patients"]').addEventListener('click', loadPatientsTab);
...
async function loadPatientsTab() {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document
      ...
      .addEventListener("submit", savePatientInfo);
    document
      .getElementById("delete-patient")
      .addEventListener("click", deletePatient);
    document
      .getElementById("add-procedure")
      .addEventListener("click", showAddProcedureForm);
  });
